...
func TestCreatePartChangesPartNotFound(t *testing.T) {
	...
	req := authedRequest("POST", "/api/v1/parts/NONEXIST/changes", []byte(body), cookie)
	w := httptest.NewRecorder()
...
func TestListPartChanges(t *testing.T) {
	...
	// List them
	req2 := authedRequest("GET", "/api/v1/parts/RES-001/changes", nil, cookie)
...
func TestDeletePartChange(t *testing.T) {
	...
	// Delete
	req2 := authedRequest("DELETE", "/api/v1/parts/RES-001/changes/"+id, nil, cookie)
	w2 := httptest.NewRecorder()
...
func TestDeletePartChangeNotDraft(t *testing.T) {
	...
	req := authedRequest("DELETE", fmt.Sprintf("/api/v1/parts/RES-001/changes/%d", id), nil, cookie)
	w := httptest.NewRecorder()
...
func TestCreateECOFromChangesNoDrafts(t *testing.T) {
	...
	req := authedRequest("POST", "/api/v1/parts/RES-001/changes/create-eco", []byte(`{}`), cookie)
	w := httptest.NewRecorder()
...
func TestApplyPartChangesOnECOImplement(t *testing.T) {
	...
	req4 := authedRequest("POST", fmt.Sprintf("/api/v1/ecos/%s/implement", ecoID), nil, cookie)
...
func TestListAllPartChanges(t *testing.T) {
	...
	req := authedRequest("GET", "/api/v1/part-changes", nil, cookie)
	w := httptest.NewRecorder()
