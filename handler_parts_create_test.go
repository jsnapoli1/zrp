...
func setupCSVPartsDir(t *testing.T) (string, func()) {
	t.Helper()
	dir := t.TempDir()
	...
	partsDir = dir
	return dir, func() { partsDir = oldPartsDir }
}

func TestCreatePart_Success(t *testing.T) {
	_, cleanup := setupCSVPartsDir(t)
	defer cleanup()
...
func TestCreateCategory_Success(t *testing.T) {
	...
	csvPath := filepath.Join(partsDir, "z-con.csv")
	...
	// Should have at least IPN and description columns
	if records[0][0] != "IPN" {
