...
func TestSalesOrderCRUD(t *testing.T) {
	...
	// Get
	req = authedRequest("GET", "/api/v1/sales-orders/"+orderID, nil, cookie)
	w = httptest.NewRecorder()
	...
	req = authedRequest("PUT", "/api/v1/sales-orders/"+orderID, []byte(body), cookie)
	w = httptest.NewRecorder()
...
func TestSalesOrderStatusFilter(t *testing.T) {
	...
	// Filter by customer
	req = authedRequest("GET", "/api/v1/sales-orders?customer=Alpha", nil, cookie)
	w = httptest.NewRecorder()
	handleListSalesOrders(w, req)
	orders = extractSalesOrders(t, w.Body.Bytes())
	if len(orders) != 1 {
...
func TestSalesOrderWorkflow(t *testing.T) {
	...
	// Confirm
	req = authedRequest("POST", "/api/v1/sales-orders/"+id+"/confirm", nil, cookie)
	w = httptest.NewRecorder()
	...
	// Allocate
	req = authedRequest("POST", "/api/v1/sales-orders/"+id+"/allocate", nil, cookie)
	w = httptest.NewRecorder()
	...
	// Pick
	req = authedRequest("POST", "/api/v1/sales-orders/"+id+"/pick", nil, cookie)
	w = httptest.NewRecorder()
	...
	// Ship
	req = authedRequest("POST", "/api/v1/sales-orders/"+id+"/ship", nil, cookie)
	w = httptest.NewRecorder()
	...
	// Invoice
	req = authedRequest("POST", "/api/v1/sales-orders/"+id+"/invoice", nil, cookie)
	w = httptest.NewRecorder()
