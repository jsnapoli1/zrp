...
func setupDocsTestDB(t *testing.T) *sql.DB {
	...
	_, err = testDB.Exec(`
		CREATE TABLE documents (
			...
			status TEXT DEFAULT 'draft' CHECK(status IN ('draft','approved','obsolete','released')),
			content TEXT,
			file_path TEXT,
...
func TestHandleListDocs_WithData(t *testing.T) {
	...
	_, err := testDB.Exec(`INSERT INTO documents (id, title, category, ipn, revision, status, created_at) VALUES
...
func TestHandleGetDoc_Success(t *testing.T) {
	...
	_, err := testDB.Exec(`INSERT INTO documents (id, title, category, ipn, revision, status, content, created_by, created_at, updated_at) VALUES
	...
	// Add attachment
	_, err = testDB.Exec(`INSERT INTO attachments (id, module, record_id, filename, original_name, size_bytes, mime_type, uploaded_by, created_at) VALUES
...
func TestHandleUpdateDoc_Success(t *testing.T) {
	...
	_, err := testDB.Exec(`INSERT INTO documents (id, title, category, status, created_by, created_at, updated_at) VALUES
...
func TestHandleUpdateDoc_PreservesStatus(t *testing.T) {
	...
	_, err := testDB.Exec(`INSERT INTO documents (id, title, status, created_by, created_at, updated_at) VALUES
...
func TestHandleDocs_SQLInjectionAttempt(t *testing.T) {
	...
	var count int
	err := testDB.QueryRow("SELECT COUNT(*) FROM documents").Scan(&count)
	if err != nil {
...
func TestHandleDocs_CategoryFilter(t *testing.T) {
	...
	_, err := testDB.Exec(`INSERT INTO documents (id, title, category, created_at) VALUES
